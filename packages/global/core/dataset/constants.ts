...
export enum DatasetSearchModeEnum {
  ...
  graphFullTextRecall = 'global',
  graphLocalTextRecall = 'local'
}
...
export const DatasetSearchModeMap = {
  ...
  [DatasetSearchModeEnum.graphFullTextRecall]: {
    icon: 'core/dataset/fullTextRecall',
    title: 'core.dataset.graph.search.mode.fullTextRecall',
    desc: 'core.dataset.graph.search.mode.fullTextRecall desc',
    value: DatasetSearchModeEnum.graphFullTextRecall
  },
  [DatasetSearchModeEnum.graphLocalTextRecall]: {
    icon: 'core/dataset/fullTextRecall',
    title: 'core.dataset.graph.search.mode.localTextRecall',
    desc: 'core.dataset.graph.search.mode.fullTextRecall desc',
    value: DatasetSearchModeEnum.graphLocalTextRecall
  }
};
