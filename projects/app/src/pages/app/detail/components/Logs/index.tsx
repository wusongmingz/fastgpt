...
const Logs = () => {
  ...
  return (
    <Flex flexDirection={'column'} h={'calc(100vh - 210px)'} mb={'10px'}>
      {isPc && (
        <Flex
          {...cardStyles}
          direction={'column'}
        ...
        >
          ...
          >
            <Box fontWeight={'700'} fontSize={['md', '18px']} color={'#000'} mb={2}>
              {t('app:chat_logs')}
            </Box>
            <Box pl={4} pt={3} color={'myGray.500'} alignContent={'end'} fontSize={'12px'}>
          ...
          >
            <TableContainer mt={[0, 3]} flex={'1 0 0'} h={0} overflowY={'auto'}>
              <Table variant={'simple'} fontSize={'sm'}>
                <Thead>
                  <Tr bgColor={'#E2E3EA !important'} borderRadius={'none important'}>
                        ...
                        <Box>
                          {!!item.outLinkUid ? (
                            ...
                            <HStack>
                              <Avatar
                                src={
                                  teamMembers.find((v) => v.tmbId === item.tmbId)?.avatar ||
                                  userInfo?.avatar
                                }
                                w="1.25rem"
                              />
