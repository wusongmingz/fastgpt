...
const SelectUsingWayModal = ({ share, onClose }: { share: OutLinkSchema; onClose: () => void }) => {
  ...
  const VariableTypeList = [
    {
      title: <Box>{t('common:core.app.outLink.Link block title')}</Box>,
      value: UsingWayEnum.link
    },
    {
      title: <Box>{t('common:core.app.outLink.Iframe block title')}</Box>,
      value: UsingWayEnum.iframe
    },
    {
      title: <Box>{t('common:core.app.outLink.Script block title')}</Box>,
      ...
      <ModalBody py={4}>
            ...
            <>
              ...
              <Flex {...gridItemStyle}>
                ...
                <MyImage
                  ...
                  src={'/imgs/images/picture/upload.png'}
                  alt={''}
                  w={'25px'}
                  h={'25px'}
                  cursor={'pointer'}
        ...
        <Box borderRadius={'md'} bg={'myGray.100'} overflow={'hidden'} fontSize={'sm'}>
          ...
          >
            ...
            <AIcon
              name="icon-fuzhi"
              color="rgb(18,107,134)"
              onClick={async () => {
                await copyData(wayMap[getValues('usingWay')].code);
              }}
              cursor={'pointer'}
            ></AIcon>
            {/* <MyIcon
          ...
          <Box whiteSpace={'pre'} p={3} overflowX={'auto'} bg={'rgb(236,239,346)'}>
