                    ...
                    <>
                      <Box
                        ...
                        {...(templateType === item.value
                          ? { borderBottom: '1px solid #d7000f', color: '#d7000f' }
                          : '')}
                        onClick={() => {
                          loadNodeTemplates({
                            type: item.value,
      ...
      <Box mx={'auto'}>
        {formatTemplates.map((item, i) => (
          <Box
            ...
            _notLast={{ pb: 5, borderBottom: '1px solid #e2e3ea' }}
          >
            ...
            <Stack>
              {item.list.map((template) => (
                ...
                >
                  ...
                  {template.isSimpleApp && (
                    <AIcon
                      name="icon-biaoqian1"
                      fontSize="25px"
                      w={'35px'}
                      color={template.selectColor}
                    ></AIcon>
                  )}
                  {template.isWorkflow && (
                    <AIcon
                  ...
                  <Box ml={2} flex={'1'} p={2}>
                    ...
                    <Box fontSize={'12px'} color={'#7f7f7f'}>
