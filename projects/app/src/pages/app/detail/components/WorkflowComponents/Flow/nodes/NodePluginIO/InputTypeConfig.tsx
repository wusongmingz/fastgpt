...
const InputTypeConfig = ({
  ...
  return (
    <Stack flex={1} borderRadius={'10px 0px 0px 10px'} justifyContent={'space-between'}>
      <Flex
        flexDirection={'column'}
        p={8}
        pb={2}
        borderLeft={'1px solid #E2E3EA'}
      ...
      <Flex justify={'flex-end'} gap={3} pb={2} pr={2}>
        <Button
          variant={'whiteBase'}
          fontWeight={'medium'}
          size={'sm'}
        ...
        {!isEdit && (
          <Button
            ...
            onClick={handleSubmit((data) => {
              if (data.min && data.max && data.min > data.max) {
                toast({
                  title: t('common:common.max cant small min'),
                  status: 'warning',
                  duration: 2000,
                  position: 'top'
                });
