    ...
    <Box display={['block', 'flex']} alignItems={'center'} gap={2}>
      ...
      {datasetDetail.permission.hasWritePer && (
        <Box textAlign={'end'} mt={[3, 0]} display={'flex'}>
          ...
          {datasetDetail?.type === DatasetTypeEnum.graph && total === 0 && (
            <MyMenu
              offset={[0, 5]}
              Button={
                <MenuButton
              ...
              menuList={[
                {
                  children: [
                    ...
                    // },
                    {
                      label: <Flex>{t('common:core.dataset.Text collection')}</Flex>,
                      onClick: onOpenFileSourceSelector
                    }
                  ]
                }
      ...
      {isOpenFileSourceSelector && (
        <FileSourceSelector datasetType={datasetDetail?.type} onClose={onCloseFileSourceSelector} />
      )}
    </Box>
  );
};
