...
import { LOGIN_ICON, LOGO_ICON } from '@fastgpt/global/common/system/constants';
...
const FormLayout = ({ children, setPageType, pageType }: Props) => {
  ...
  const { lastRoute = '/applicationCenter' } = router.query as { lastRoute: string };
    ...
    <Flex flexDirection={'column'} h={'100%'}>
      <Flex alignItems={'center'} justify={'space-between'}>
        <Flex alignItems={'center'}>
          <Box ml={[3, 5]} fontSize={['2xl', '4xl']} fontWeight={'bold'} color={'myGray.900'}>
          ...
          >
            <MyImage src={LOGIN_ICON} w={['90px', '180px']} alt={'icon'} />
          </Flex>
