...
export const postCreateUser = (data: {
  ...
  groupId: string;
  role?: string;
}) => POST('/support/user/team/members/create', data);

export const updateUserPassword = (data: { tmbId: string; password: string }) =>
  POST('/support/user/team/members/updatePassword', data);
