...
import { getTeamLists, getTeamPlanStatus } from './team/api';
...
import { getDefaultTeamGroup, getGroupList } from './team/group/api';
...
type State = {
  ...
  setTeamList: (list?: TeamType[]) => void;

  defaultGroup: MemberGroupSchemaType;
  setDefaultGroup: (group: MemberGroupSchemaType) => void;
    ...
    persist(
      immer((set, get) => ({
        ...
        async initUserInfo() {
          ...
          get().setTeamList(teamlist);

          const defaultGroup = (await getDefaultTeamGroup()) as any as MemberGroupSchemaType;
          get().setDefaultGroup(defaultGroup);
          //设置html的fontsize
        ...
        defaultGroup: {} as MemberGroupSchemaType,
